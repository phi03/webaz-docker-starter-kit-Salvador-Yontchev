...
DROP TABLE IF EXISTS public.objets;
...
INSERT INTO public.objets (id, nom, img, depart, fin, type_objet, indice, objet_bloquant, objet_libere, code, geom, zoom_min)
VALUES 

-- DÉTROIT DE MALACCA

(1, 'Boussole ancienne', '../assets/img/boussole_malacca.png', TRUE, FALSE, 'récupérable',
 'Une boussole. Servira peut-être plus tard...',
 NULL, NULL, NULL,
 ST_SetSRID(ST_MakePoint(103.94, 1.045), 4326), 10),

(2, 'Coffre du Capitaine', '../assets/img/coffre_malacca.png', TRUE, TRUE, 'bloqué_par_code',
 'Je me souviens avoir laissé le code dans mon carnet... Mais où peut-il être ? ',
 NULL, NULL, 1492,
 ST_SetSRID(ST_MakePoint(101.45, 1.68), 4326), 10),

(3, 'Panneau du détroit de Malacca', '../assets/img/panneau.png', TRUE, FALSE, 'indication',
...
(4, 'Clé de la cale', '../assets/img/cle_cale.png', TRUE, FALSE, 'récupérable',
 'Une clé ? Elle doit sans doute ouvrir quelque chose...',
 NULL, NULL, NULL,
 ST_SetSRID(ST_MakePoint(43.42, 12.65), 4326), 11),

(5, 'Coffre à carburant', '../assets/img/coffre_bab.png', TRUE, FALSE, 'bloqué_par_objet',
 'Ce coffre est scellé. Il me faudrait une clé...',
 4, 6, NULL,
 ST_SetSRID(ST_MakePoint(43.25, 13.27), 4326), 10),

(6, 'Amulette du navigateur', '../assets/img/amulette.png', FALSE, FALSE, 'récupérable',
 'Trouvé dans le coffre à carburant. Il me servira sans doute plus tard...',
 NULL, NULL, NULL,
 ST_SetSRID(ST_MakePoint(43.25, 13.27), 4326), 10),

(7, 'Panneau du détroit de Bab-El-Mandeb', '../assets/img/panneau.png', TRUE, FALSE, 'indication',
...
(8, 'Panneau du Canal de Suez', '../assets/img/panneau.png', TRUE, FALSE, 'indication',
...
(9, 'Plan du cargo Ever Given', '../assets/img/plan.png', TRUE, FALSE, 'code',
 NULL,
...
(10, 'Porte du port', '../assets/img/port.png', TRUE, FALSE, 'bloqué_par_code',
 ...
 NULL, 11, 1973,
 ST_SetSRID(ST_MakePoint(-5.35, 36.14), 4326), 13),

(11, 'Coffret du navigateur', '../assets/img/coffret_navigateur.png', FALSE, FALSE, 'bloqué_par_objet',
 'Mon amulette me permet d’obtenir de précieuses informations',
 6, 12, NULL,
 ST_SetSRID(ST_MakePoint(-5.45, 36.13), 4326), 13),

(12, 'Panneau du détroit de Gibraltar', '../assets/img/panneau.png', FALSE, FALSE, 'indication',
...
(13, 'Panneau du canal de Panama', '../assets/img/panneau.png', TRUE, FALSE, 'indication',
 ...
 NULL, NULL, NULL,
 ST_SetSRID(ST_MakePoint(-79.62, 9.03), 4326), 11),
...
(14, 'Portes de l’écluse', '../assets/img/porte.png', TRUE, FALSE, 'bloqué_par_objet',
 ...
 1, 15, NULL,
 ST_SetSRID(ST_MakePoint(-79.70, 9.05), 4326), 12),

(15, 'Carnet du capitaine', '../assets/img/carnet.png', FALSE, FALSE, 'code',
 NULL,
 NULL, NULL, 'Un carnet humide où figure une note : “Date de création du Sancocho : 1 4 9 2.”',
 ST_SetSRID(ST_MakePoint(-79.49, 9.00), 4326), 10);
...
CREATE INDEX idx_geom_objet ON public.objets USING gist (geom) WITH (fillfactor='90', buffering=auto);